...
us_enrichment_business_search_api:
	dotnet run --project $(EXAMPLES_PROJECT) -- us_enrichment_business_search

us_enrichment_etag_api:
	dotnet run --project $(EXAMPLES_PROJECT) -- us_enrichment_etag
...
us_street_with_http_factory_api:
	dotnet run --project $(EXAMPLES_PROJECT) -- us_street_with_http_factory
...
# Run all examples
examples: international_autocomplete_api international_street_api international_postal_code_api us_autocomplete_pro_api us_enrichment_api us_enrichment_business_search_api us_extract_api us_reverse_geo_api us_street_api us_street_iana_timezone_api us_zipcode_api
