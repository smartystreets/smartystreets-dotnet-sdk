...
namespace SmartyStreets
{
    ...
    public class CustomHeaderSenderTests
    {
        ...
        [Test]
        public async Task TestMultipleAppendedHeadersAccumulate()
        {
            var appendHeaders = new Dictionary<string, AppendedHeader>();
            appendHeaders["User-Agent"] = new AppendedHeader("my-app/1.0", " ");
            appendHeaders["User-Agent"] = new AppendedHeader(appendHeaders["User-Agent"].Value + " " + "my-lib/2.0", " ");
            ...
            Assert.AreEqual("smarty-sdk/1.0 my-app/1.0 my-lib/2.0", mockSender.Request.Headers["User-Agent"]);
        }
